...
-- Completion
-- blink.cmp drives the popup; disable the native 0.12 'autocomplete' to avoid a double menu.
-- completeopt is still consumed by blink for menuone / noselect semantics.
