-- Adwaita Dark (vibrant). Highlights only — built-in groups + treesitter +
-- LSP semantic tokens + native diagnostics. No plugin-specific groups.
...
function M.set()
  ...
  -- Split / terminal borders → vibrant Adwaita orange (everywhere).
  ...
  -- ===========================================================================
  hl("netrwDir",          { fg = c.blue_2,  bold = true })
  hl("netrwClassify",     { fg = c.orange_3 })
  hl("netrwLink",         { fg = c.s_teal })
  hl("netrwSymLink",      { fg = c.s_teal,  italic = true })
  hl("netrwExe",          { fg = c.green_3, bold = true })
  hl("netrwTreeBar",      { fg = c.dark_1 })
  hl("netrwHelpCmd",      { fg = c.orange_2 })
  hl("netrwMarkFile",     { fg = c.purple_2, bold = true })
